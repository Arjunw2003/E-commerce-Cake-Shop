                ...
                <form id="login-form" method="post">
                    ...
                    <p>
                        ...
                        <p>
                            ...
                            <p>
                                <input type="text" id="email" name="meassage" placeholder="MEASSAGE" required><i
                                    class="validation"><span></span><span></span></i>
                            </p>
                            <p>
                                <?php } ?>
                                <input type="submit" id="login" value="PLACE ORDER " name="mainbuy_buy" class="placeord" onclick="fun3()">
                            </p>
                </form>
