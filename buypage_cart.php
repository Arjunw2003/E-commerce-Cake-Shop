...
<body>
                        ...
                        <p>
                            ...
                            <p>
                                ...
                                <p>
                                    ...
                                    <p>
                                        <input type="text" id="meassage" name="postalzipcode" placeholder="MEASSAGE" required><i
                                            class="validation"><span></span><span></span></i>
                                    </p>
                                    
                                    <p>
                                        <input class="placeord" type="submit" id="login" value="PLACE ORDER " name="mainbuy_cart" onclick="fun3()">
                                    </p>
                    <?php } ?>
                </form>
    ...
    <script>
		function fun3(){
			alert("Dear Customer Thanks for placing on order with Monginis. We are placed to Confirm 😊")
		}
	</script>
</body>
...
while ($i < count($arr_cakeprice)) {
    ...
    if (isset($_POST['mainbuy_cart'])) {
        ...
        $meassage = mysqli_real_escape_string($db, $_POST['meassage']);
        ...
        if (count($errors) == 0) {
            ...
            $query = "INSERT INTO orders (name,email, mobilenumber,state,city,postalzipcode,meassage,cakeimg,caketype,cakeprice) 
  			  VALUES('$name', '$email','$mobilenumber','$state','$city','$postalzipcode',''$meassage,'$cakeimg','$caketype','$cakeprice')";
