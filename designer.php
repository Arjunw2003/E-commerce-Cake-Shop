...
$sql = " SELECT * FROM `designer`  "; #line to be change
            ...
            <div class="container_1">
                <form method="post">
                    ...
                    <div class="container_1_price">
                        ...
                        <label style="color:lime;margin-left:1vw">
                            <?php echo '₹', $rows['disc_val'] ?>
                        </label>
                        <br>
                        <label style="text-decoration: line-through">
                            <?php echo '₹', $rows['cakeprice'] ?>
                        </label>
                        <input type="hidden" name="cakeprice" value="<?php echo $rows['disc_val'] ?>">
                    </div>
